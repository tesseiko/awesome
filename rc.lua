...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "apostrophe", function () viber_scratch:toggle() end,
    ...
    awful.key({ "Shift" }, "Print", function() awful.spawn("maimpick") end,
              {description = "Print screen options", group = "launcher"}),
    ...
    -- Menubar
    awful.key({ modkey }, "d", function() awful.spawn("rofirun") end,
...
awful.spawn.with_shell("systemd-notify --ready --status=\"dwm started\"")
-- }}}
